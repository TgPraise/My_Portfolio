...
import profilePhoto from "../assets/Temitope_official.jpg";
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex items-center gap-6 pt-6">
              ...
              <div className="flex items-center gap-4">
                <a 
                  href="https://github.com/TgPraise" 
                ...
                <a 
                  href="https://www.linkedin.com/in/temitope-olakunle-1b1741336/" 
                  className="text-gray-400 hover:text-blue-500 transition-colors duration-200"
                  aria-label="LinkedIn"
                >
          ...
          <div className="flex justify-center lg:justify-end animate-fade-in">
            <div className="relative">
              ...
              <div className="relative w-72 h-72 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-white/10 shadow-2xl">
                <img
                  src={profilePhoto}
                  alt="Temitope Olakunle - Full Stack Developer"
