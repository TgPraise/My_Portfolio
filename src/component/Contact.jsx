  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "olakunlet949@gmail.com",
      href: "mailto:olakunlet949@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+234 704 204 0987",
      href: "tel:+2347042040987"
    },
    {
      icon: MapPin,
      label: "Location",
      value: "Akwa Ibom State, Uyo",
      href: "https://www.google.com/maps/place/Akwa+Ibom+State"
    }
  ];

  const socialLinks = [
    { icon: Github, label: "GitHub", href: "https://github.com/TgPraise/" },
    { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/temitope-olakunle-1b1741336/" },
    { icon: Twitter, label: "Twitter", href: "https://x.com/code_king1" },
  ];

  const handleDownloadResume = () => {
    const link = document.createElement('a');
    link.href = resumePDF;
    link.download = 'Temitope_resume.pdf';
