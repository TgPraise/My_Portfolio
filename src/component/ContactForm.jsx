...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const serviceId = 'service_x6rk5fm';
      const templateId = 'template_uzdtyfg';
      const publicKey = 'SEbg137SFwj6p0FVG';
      ...
      const templateParams = {
        ...
        to_email: 'olakunlet949@gmail.com'
      };
      ...
      alert('Error sending message. Please try emailing me directly at olakunlet949@gmail.com');
    } finally {
